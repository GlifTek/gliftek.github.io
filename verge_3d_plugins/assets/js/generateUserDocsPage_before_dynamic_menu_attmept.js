...
function makeALL_OF_ALLPageImages()
{
  ...
  makeALLPageImages ( LIST_images_extra, 'extra', 'width: 55%');
...
function makeSingleImage ( i, list, imageName, suffix, width )
{
  ...
  let imageNameFull =
  // imageDir + imagePrefix + '_' + page + '_' + pluginPack_title_UpperCase + '_' + imageName + '_' + suffix + '.png';
  // './images/GLIFTEK_plugins_' + pluginPack_title_UpperCase + '_' + imageName + '_' + suffix + '.png';


  // imageDir + imagePrefix + '_' + pluginPack_title_UpperCase + '_' + imageName + '_' + suffix + '.png';
...

{
  ...
  <ul class="icons">
    <li><a href="${gliftek_contactInfo.twitter}" class="icon brands fa-twitter"><span class="label">Twitter</span></a></li>
    <li><a href="${gliftek_contactInfo.facebook}" class="icon brands fa-facebook-f"><span class="label">Facebook</span></a></li>
    <li><a href="${gliftek_contactInfo.instagram}" class="icon brands fa-instagram"><span class="label">Instagram</span></a></li>
    <li><a href="${gliftek_contactInfo.github}" class="icon brands fa-github"><span class="label">GitHub</span></a></li>
    <li><a href="${gliftek_contactInfo.discordVerge3D}" class="icon brands fa-discord"><span class="label">Discord</span></a></li>
  </ul>
</nav>`;
...
function set_post_HTML( pluginName, pic )
{
  ...
  `<!-- ${pluginName_UpperCase} -->
    ...
    <div class="align-center">
      ...
      <div id='${divPluginPic}' style = 'width: ${pluginWidth}'></div>
