 ...
 * Sat Aug 21 2021 15:11:10 GMT-0400 (Eastern Daylight Time)
...
this.procedures["RESET_SCENE"] = RESET_SCENE;
...
var obj, save_object, loaded_DICTIONARY, DICT_load_object, current_color, current_object, DICT_object_colors, LIST_objects, EXEC_TEXT_instructions, i, DICT_save_object, my_saved_key, DICT_save_all_objects, m, load_object, next_color, length_of_CSV, LIST_keys_from_database, LIST_colors, LIST_hitboxes, my_database, my_dataStore, my_description, DICT_save_object_POSITION, j, LIST_text_items, selected_item, DICT_save_object_ROTATION, selected_object_Hitbox, DICT_save_object_SCALE, LIST_text_colors, load_object_color, load_object_material;
...
// Describe this function...
function SET_LISTS() {
  LIST_objects = ['Cube', 'Cone', 'Torus'];
  LIST_colors = ['red', 'green', 'blue'];
  LIST_text_items = ['SAVE_KEY', 'LOAD_KEY'];
  LIST_text_colors = ['green', 'red'];
  LIST_hitboxes = ['SAVE_KEY_HITBOX ', 'LOAD_KEY_HITBOX '];
...
function CLICK_MENU_ITEMS() {
  registerOnClick(LIST_hitboxes, false, false, [0,1,2], function() {
    selected_object_Hitbox = _pGlob.pickedObject;
    selected_item = subsequenceFirstFromEnd(_pGlob.pickedObject, 8);
    console.log('selected item: ');
    console.log(selected_item);
    outline(selected_object_Hitbox, 'ENABLE');
    registerSetTimeout(0.15, function() {
      outline(selected_object_Hitbox, 'DISABLE');
    });
    var VARS = Object.defineProperties({}, {
    "obj": { get: function() { return obj; }, set: function(val) { obj = val; } },
    "save_object": { get: function() { return save_object; }, set: function(val) { save_object = val; } },
