 ...
 * Fri Aug 27 2021 22:01:43 GMT-0400 (Eastern Daylight Time)
...
this.procedures["REMOVE CONTEXT MENU"] = REMOVE_CONTEXT_MENU;
this.procedures["SET_DICT_OBJECT_COLORS"] = SET_DICT_OBJECT_COLORS;
this.procedures["CLICK_MENU_ITEMS_LOOP"] = CLICK_MENU_ITEMS_LOOP;
...
var PROC = {
    ...
    "REMOVE CONTEXT MENU": REMOVE_CONTEXT_MENU,
    "SET_DICT_OBJECT_COLORS": SET_DICT_OBJECT_COLORS,
    "CLICK_MENU_ITEMS_LOOP": CLICK_MENU_ITEMS_LOOP,
    "SET_LISTS": SET_LISTS,
...
var current_color, current_object, obj, save_object, loaded_DICTIONARY, DICT_load_object, DICT_object_colors, i, selected_item, next_color, EXEC_TEXT_instructions, DICT_save_object, my_saved_key, DICT_save_all_objects, m, load_object, length_of_CSV, LIST_keys_from_database, LIST_hitboxes, LIST_hovered_items, selected_object_Hitbox, DICT_save_object_POSITION, LIST_objects, my_database, my_dataStore, my_description, j, DICT_save_object_ROTATION, DICT_save_object_SCALE, LIST_text_items, load_object_color, LIST_colors, load_object_material, color_of_clicked_menu_item;
...
function REMOVE_CONTEXT_MENU() {
  var VARS = Object.defineProperties({}, {
    ...
    "LIST_hovered_items": { get: function() { return LIST_hovered_items; }, set: function(val) { LIST_hovered_items = val; } },
    ...
    "selected_object_Hitbox": { get: function() { return selected_object_Hitbox; }, set: function(val) { selected_object_Hitbox = val; } },
    ...
    "color_of_clicked_menu_item": { get: function() { return color_of_clicked_menu_item; }, set: function(val) { color_of_clicked_menu_item = val; } },
});
...
function SET_DICT_OBJECT_COLORS() {
  ...
  dictSet(DICT_object_colors, 'Cone', 'green');
...
function SETUP_OBJECTS() {
  ...
  HOVER_MENU_ITEMS();
  CLICK_OBJECTS();
  CLICK_MENU_ITEMS_LOOP();
}

// Describe this function...
function CLICK_MENU_ITEMS_LOOP() {
  for (var i_index in LIST_hitboxes) {
    i = LIST_hitboxes[i_index];
    CLICK_MENU_ITEMS(i);
  }
}
...
function SET_LISTS() {
  selected_item = null;
  LIST_hovered_items = getObjectsFrom(['GROUP', 'HOVERED_ITEMS'], 'MESH');
  LIST_objects = getObjectsFrom(['GROUP', 'OBJECTS'], 'MESH');
  LIST_hitboxes = getObjectsFrom(['GROUP', 'HITBOXES'], 'MESH');
  LIST_text_items = getObjectsFrom(['GROUP', 'TEXT_ITEMS'], 'MESH');
  LIST_colors = ['red', 'green', 'blue'];
  changeVis('RESET_SCENE', false);
  changeVis('RESET_SCENE_HITBOX ', false);
}
...
// Describe this function...
function CLICK_MENU_ITEMS(obj) {
  registerOnClick(obj, false, false, [0,1,2], function() {
    selected_object_Hitbox = obj;
    console.log('selected_object_Hitbox: ');
    console.log(selected_object_Hitbox);
    selected_item = obj.slice(0, obj.length - 8);
    console.log('selected item: ');
    console.log(selected_item);
    color_of_clicked_menu_item = getMaterialColor(getObjectMaterial(selected_item), 'Color', 'CSS_HEX');
    setMaterialColor(getObjectMaterial(selected_item), 'Color', 0, 0, 0, 'white');
    registerSetTimeout(1, function() {
      setMaterialColor(getObjectMaterial(selected_item), 'Color', 0, 0, 0, color_of_clicked_menu_item);
    });
    var VARS = Object.defineProperties({}, {
    "obj": { get: function() { return obj; }, set: function(val) { obj = val; } },
    "save_object": { get: function() { return save_object; }, set: function(val) { save_object = val; } },
...
function SET_CONSTRAINTS() {
  objConstraintAddLimit('myConst1', LIST_objects, 'POS_X', -8, 8, undefined, undefined, undefined);
  objConstraintAddLimit('myConst2', LIST_objects, 'POS_Y', -3, 4, undefined, undefined, undefined);
}
...
function HOVER_MENU_ITEMS() {
  registerOnHover(LIST_hovered_items, false, function() {
...
function DRAG_OBJECTS_LOOP() {
  for (var i_index2 in LIST_objects) {
    i = LIST_objects[i_index2];
    DRAG_OBJECTS(i);
  }
}
...
// Describe this function...
function SAVE_KEY() {
  console.log('procedure "SAVE_KEY" running.');
...
// Describe this function...
function LOAD_KEY() {
  console.log('procedure "LOAD_KEY" running.');
  waitPromise(
...
function APPLY_LOADED_DATA_TO_OBJECTS(DICT_load_object) {
  ...
  setObjTransform(load_object, 'position', createVector(dictGet(dictGet(DICT_load_object, 'position'), 'x'), dictGet(dictGet(DICT_load_object, 'position'), 'y'), dictGet(dictGet(DICT_load_object, 'position'), 'z')), false);
  setObjTransform(load_object, 'rotation', createVector(dictGet(dictGet(DICT_load_object, 'rotation'), 'x'), dictGet(dictGet(DICT_load_object, 'rotation'), 'y'), dictGet(dictGet(DICT_load_object, 'rotation'), 'z')), false);
  setObjTransform(load_object, 'scale', createVector(dictGet(dictGet(DICT_load_object, 'scale'), 'x'), dictGet(dictGet(DICT_load_object, 'scale'), 'y'), dictGet(dictGet(DICT_load_object, 'scale'), 'z')), false);
