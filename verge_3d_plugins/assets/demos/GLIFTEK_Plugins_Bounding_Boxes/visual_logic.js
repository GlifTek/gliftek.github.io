/**
 * Generated by Verge3D Puzzles v.3.8.0 pre5
 * Thu Sep 09 2021 22:45:29 GMT-0400 (Eastern Daylight Time)
...
this.procedures["do something3"] = do_something3;
...
var PROC = {
    ...
    "do something3": do_something3,
};

var object_in_list, obj, touching, readout_for_selected_object, LIST_Objects, selected_object, touched_object, DICT_object_colors, object_touching, object_for_color, object_NOT_touching, LIST_all_touching_objects, j, readout_for_all_objects;
...
//  PUZZLE CORE CODE
            ...
            gridHelper.name = 'gridHelper_' + gridHelperNumber;
...
function TEXT_READOUT() {
  ...
  setHTMLElemStyle('fontFamily', 'Arial', 'readout_for_selected_object', false);
  setHTMLElemStyle('zIndex', '2', 'readout_for_selected_object', false);
  ...
  setHTMLElemStyle('fontFamily', 'Arial', 'readout_for_all_objects', false);
  setHTMLElemStyle('zIndex', '2', 'readout_for_all_objects', false);
...
function do_something() {
  for (var object_in_list_index in LIST_Objects) {
    ...
    do_something2(object_in_list);
  }
}


function getListOfTouchingOrNotObjects() {
    return (function
//____________________________________________________________________________________
// ALL ARGUMENTS USED FROM INPUTS
...
//  DECLARE VARIABLES
    ...
    const puzzleName = 'Get List Of All Touching or Not Touching Objects';

    let LIST_touching_or_not_objects = [];
//________________________________________________________________________________
//  NO INPUT ERROR CHECK
...
//  CORE CODE
            ...
            window.LIST_Box3s.forEach((Box3) =>
            {
                ...
                if  ( typeDropdown == 'touching')
                {

                    if ( collision == true )
                    {
                        LIST_touching_or_not_objects.push(Box3.id);
                        console.log('LIST_touching_or_not_objects after push:',LIST_touching_or_not_objects);
                    }

                }

                else if ( typeDropdown == 'not_touching' )
                {
...
// PUZZLE OUTPUT
    ...
    return LIST_touching_or_not_objects;
...
function CHANGE_COLORS_OF_ALL() {
  ...
  var object_touching_list =

          getListOfTouchingOrNotObjects
          (
              'touching'
          );
          ;
  for (var object_touching_index in object_touching_list) {
    object_touching = object_touching_list[object_touching_index];
...
// Describe this function...
function do_something2(obj) {
  registerOnDrag(obj, false, [0,1,2], function() {}, function() {
    selected_object = obj;
    changeVis(String(selected_object) + '_Box3_Helper', true);
    dragMove(obj, 'XY', '?1BsHS%9;#@DGTpiI_gD', ']v@c60@wY6_Vi]C!3A]p');
    do_something3(obj);
  }, function() {}, ']v@c60@wY6_Vi]C!3A]p');
}
...
// Describe this function...
function do_something3(obj) {
  whenMoved(obj, 0.01, function() {
