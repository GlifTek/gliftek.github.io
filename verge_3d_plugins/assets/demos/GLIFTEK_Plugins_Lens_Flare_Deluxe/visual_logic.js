 ...
 * Mon Sep 06 2021 12:55:39 GMT-0400 (Eastern Daylight Time)
...
this.procedures["LENS_FLARES_PROCEDURES"] = LENS_FLARES_PROCEDURES;
this.procedures["MAIN"] = MAIN;
this.procedures["FADE_IN"] = FADE_IN;
this.procedures["SWITCH_FLARE_FADE"] = SWITCH_FLARE_FADE;
...
this.procedures["SET_VARIABLES"] = SET_VARIABLES;
this.procedures["SET_CAM_AND_LIGHT"] = SET_CAM_AND_LIGHT;
...
this.procedures["CLICK_NEXT_BUTTON"] = CLICK_NEXT_BUTTON;
...
var PROC = {
    ...
    "LENS_FLARES_PROCEDURES": LENS_FLARES_PROCEDURES,
    "MAIN": MAIN,
    "FADE_IN": FADE_IN,
    ...
    "SET_CAM_AND_LIGHT": SET_CAM_AND_LIGHT,
...
var lens_flare_counter, RAYS_01, BOKEH_01, GLOW_01, RAYS_2, BOKEH_2, GLOW_2, RAYS_3, BOKEH_3, GLOW_3, LIST_bg_images, center_alpha_distance_02;
...
// Describe this function...
function LENS_FLARES_PROCEDURES() {
...
function lensFlareSettingsRAYS() {
    return (function(e,l,a,t,i,r,n,d,o,s,p,c){return new Map([["type","RAYS"],["shape","RAYS"],["rays",e],["nameInput",l],["symmetrical",a],["rayWidth",t],["raySharpness",i],["randomSeed",r],["rotate",n],["feBlur",d],["opacity",o],["size",s],["distance",p],["color",c]])}).apply(null, arguments);
}
...
function lensFlareSettingsBOKEH() {
    return (function(e,l,t,a,o,n,i,p){return new Map([["type","BOKEH"],["shape",e],["vert",l],["rotate",t],["feBlur",a],["opacity",o],["size",n],["distance",i],["color",p]])}).apply(null, arguments);
}
...
function lensFlareSettingsGLOW() {
    return (function(e,l,t,a,o,n,i,p,d,c,s,r,_){return new Map([["type","GLOW"],["nameInput",e],["shape",l],["toneCenter",t],["toneInner",a],["toneMid",o],["toneOuter",n],["toneEdge",i],["rotate",p],["feBlur",d],["opacity",c],["size",s],["distance",r],["color",_]])}).apply(null, arguments);
}
