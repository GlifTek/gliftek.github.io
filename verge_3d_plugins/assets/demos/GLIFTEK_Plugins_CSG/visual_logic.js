 ...
 * Mon Aug 30 2021 17:40:29 GMT-0400 (Eastern Daylight Time)
...
this.procedures["HOVER_CLICK_LOOP"] = HOVER_CLICK_LOOP;
this.procedures["HOVER_CLICK"] = HOVER_CLICK;
...
this.procedures["DRAG_NEW_OBJECT"] = DRAG_NEW_OBJECT;

var PROC = {
    "MAKE_CLONES": MAKE_CLONES,
    "MAIN": MAIN,
    "HOVER_CLICK_LOOP": HOVER_CLICK_LOOP,
    "HOVER_CLICK": HOVER_CLICK,
    "CONSTRAINTS": CONSTRAINTS,
    "CONSTRAINTS_NEW": CONSTRAINTS_NEW,
    "RESET_SCREEN": RESET_SCREEN,
    "DRAG_NEW_OBJECT": DRAG_NEW_OBJECT,
};

var obj, dropdown_value, i, Cube_Blue_New, Cube_Red_New;
...
// Describe this function...
function HOVER_CLICK_LOOP() {
  var i_list = getObjectsFrom(['GROUP', 'Hitboxes'], 'MESH');
...
//  PUZZLE CORE CODE
        ...
        {
            if ( typeof window.CSG_js_loaded == 'undefined')
            {
                jsFileLoaderTop(wait);
            }
            else if ( window.CSG_js_loaded == 'loaded' )
            {
                CSG_Function();
            }
...
// Describe this function...
function HOVER_CLICK(obj) {
  registerOnHover(obj, true, function() {
    setHTMLElemStyle('cursor', 'pointer', ['CONTAINER'], false);
    outline(obj.slice(obj.length - 1, 1), 'ENABLE');
  }, function() {
    setHTMLElemStyle('cursor', 'default', ['CONTAINER'], false);
    outline(obj.slice(obj.length - 1, 1), 'DISABLE');
  });
  registerOnClick(obj, true, false, [0,1,2], function() {
    dropdown_value = obj.slice(0, obj.length - 7);
    console.log('dropdown_value: ' + String(dropdown_value));
    if (dropdown_value == 'reset') {
...
function DRAG_NEW_OBJECT() {
  ...
  registerOnDrag('myNewObject', false, [0,1,2], function() {}, function() {
    dragMove('myNewObject', 'XY', '?Sb6K:HaXn-DOBtMs0|E', 'FrRRqN8wT87.inMM+2mt');
    CONSTRAINTS_NEW();
  }, function() {}, 'FrRRqN8wT87.inMM+2mt');
}
