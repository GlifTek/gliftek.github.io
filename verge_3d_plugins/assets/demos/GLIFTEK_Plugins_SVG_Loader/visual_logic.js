 ...
 * Sat Nov 13 2021 03:56:49 GMT-0500 (Eastern Standard Time)
...
function FORM_URL() {
  ...
  setHTMLElemAttribute('value', 'https://gliftek.com/verge_3d_plugins/assets/demos/GLIFTEK_Plugins_SVG_Loader/https://gliftek.com/verge_3d_plugins/assets/demos/GLIFTEK_Plugins_SVG_Loader/Recycling_symbol.svg', 'form_url', false);
  ...
  eventHTMLElem('change', 'form_url', false, function(event) {
    UPLOAD_SVG(getHTMLElemAttribute('value', 'form_url', false));
  });
}
...
function UPLOAD_SVG(file) {
  RESET_OBJECTS();
    ...
    Current_SVG = 'SVG_1';
    EXTRUDE_OBJECTS(Current_SVG, 200);
    registerSetTimeout(0.5, function() {
      Current_SVG_Extruded_Master_Control = 'SVG_SVG_1_Extruded_Master_Control';
...
function CAMERA_CONSTRAINTS() {
  objConstraintAddLimit('rotX', 'Camera', 'ROT_X', 80, 80, '', 0, 'LIMITDIST_ONSURFACE');
  objConstraintAddLimit('rotY', 'Camera', 'ROT_Y', 0, 0, '', 0, 'LIMITDIST_ONSURFACE');
  objConstraintAddLimit('rotZ', 'Camera', 'ROT_Z', 0, 0, '', 0, 'LIMITDIST_ONSURFACE');
}
            ...
            function extrudeObject(obj)
            {
                ...
                svgDataPaths.forEach((path) =>
                {
                    ...
                    else if ( svgDataPaths.length = 1 )
                    {
                        ...
                        // mesh.name = nameInput;
                        mesh.name = 'SVG_' + path.id + '_Extruded_Mesh';
                        ...
                        single_Empty.name = 'SVG_' + path.id + '_Extruded' + '_Control';
...
function VERGE_3D_LOGO(file) {
  RESET_OBJECTS();
          ...
          registerSetTimeout(0.5, function() {
    Current_SVG = 'Verge3D_Logo';
    EXTRUDE_OBJECTS('Verge3D_Logo', 200);
    registerSetTimeout(0.5, function() {
      Current_SVG_Extruded_Master_Control = 'SVG_Verge3D_Logo_Extruded_Master_Control';
      ...
      assignMat('SVG_fill_Extruded_Mesh', 'PlaneMaterial');
...
function GLIFTEK_LOGO(file) {
  RESET_OBJECTS();
          ...
          registerSetTimeout(0.5, function() {
    Current_SVG = 'GLIFTEK_Logo';
    setObjTransform('GLIFTEK_Logo', false, 'position', ['', '', 1.5], false);
    setObjTransform('GLIFTEK_Logo', false, 'scale', [0.0025, 0.0025, -0.0025], false);
    CHANGE_SVG_MESH();
    EXTRUDE_OBJECTS(Current_SVG, 30);
    registerSetTimeout(0.5, function() {
      Current_SVG_Extruded_Master_Control = 'SVG_GLIFTEK_Logo_Extruded_Master_Control';
      setObjTransform(Current_SVG_Extruded_Master_Control, false, 'position', ['', '', 0.5], false);
      changeVis('Plane', true);
      LIST_Controls_From_Extrusion =
          getItemsFromExtrusion
